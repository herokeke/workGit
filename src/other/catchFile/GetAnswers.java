...
public class GetAnswers {
    ...
    private void getAllAnswer() {
        ...
        for (String name:categoryName) {
            ...
            try {
                ...
                allPageCount = Integer.parseInt(tempDom.select(".tag-name").attr("href").split("=")[1].split("#")[0])/25 + 1;
            } catch (IOException e) {
                e.printStackTrace();
            }
    ...
    private void getCategoryLink() {
        try {
            ...
            Element categorys = dom.select(".menu-sub-list").first();
