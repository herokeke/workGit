...
@ContextConfiguration("classpath:common/spring/spring_ioc/applicationContext5.xml")
public class Demo5Test extends AbstractJUnit4SpringContextTests {

	
	@Resource(name="listUtil")
